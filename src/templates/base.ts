...
export const base = (layout: Layout, site: Site): string => {
...
<html lang="en" data-theme="light">
  ...
  <body class="root">
    <header class="header">
      ...
      <button class="theme-toggle theme-btn -light" aria-label="Toggle dark mode">
        <svg
      ...
      <button class="theme-toggle theme-btn -dark" aria-label="Toggle light mode">
        <svg
          id="dark"
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
    ...
    <footer class="footer">
      ...
      <section class="footer__icons">
        <a class="footer__icon" target="_blank" rel="noopener noreferrer" href="https://fosstodon.org/@sondre">
